...
* For other needed tools, see [INSTALL-CMake.md](https://github.com/Macaulay2/M2/blob/master/M2/INSTALL-CMake.md)
...
1. <s>Add @mahrud's repository as a remote and checkout the feature/cmake branch</s> merged now
...
```
You can confirm the versions with `gcc --version`. Versions above 7 have been tested. <s>There are known issues with `AppleClang`, so avoid that if possible.</s>
...
5. Run `ninja install-packages` to install all packages, and `ninja install` to install Macaulay2 on the system.
...
Other flags and build targets are available, see [INSTALL-CMake.md](https://github.com/Macaulay2/M2/blob/master/M2/INSTALL-CMake.md) for details.
...
* [INSTALL-CMake.md](https://github.com/Macaulay2/M2/blob/master/M2/INSTALL-CMake.md)
