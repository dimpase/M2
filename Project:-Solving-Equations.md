...
would lead to the discovery of a monic equation in the first (next) variable.
...
x and y.  We choose an elimination ordering where the variables are preferred to
the coefficients.
```m2
